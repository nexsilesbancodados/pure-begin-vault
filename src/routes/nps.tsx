        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-card border border-border rounded-2xl p-5">
              ...
              <div
                className={`text-4xl font-bold font-display mt-2 ${npsScore >= 50 ? "text-success" : npsScore >= 0 ? "text-warning" : "text-destructive"}`}
              >
                {npsScore}
              </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-5">
              <div className="flex items-center gap-2 text-success">
                ...
                <span className="text-[11px] uppercase font-bold">Promotores (9-10)</span>
              </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-5">
              <div className="flex items-center gap-2 text-warning">
                ...
                <span className="text-[11px] uppercase font-bold">Neutros (7-8)</span>
              </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-5">
              <div className="flex items-center gap-2 text-destructive">
                ...
                <span className="text-[11px] uppercase font-bold">Detratores (0-6)</span>
              </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              "De 0 a 10, o quanto você recomendaria a nossa loja?"
            </p>
            ...
            {loading ? (
              ...
              <div className="space-y-2">
                {responses.map((r) => (
                  ...
                  >
                    <div
                      className={`h-10 w-10 rounded-lg grid place-items-center font-bold text-white ${r.score >= 9 ? "bg-success" : r.score >= 7 ? "bg-warning" : "bg-destructive"}`}
                    >
                      {r.score}
                    </div>
