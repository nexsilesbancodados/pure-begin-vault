  ...
  head: () => ({
    meta: [
      { title: "ConectaCRM — ERP, CRM e IA para lojas de celular" },
      {
        name: "description",
        content:
          "ERP + CRM + IA para lojas de celular: estoque por IMEI, OS, vendas, fiscal, financeiro e WhatsApp em uma única plataforma.",
      },
      { property: "og:title", content: "ConectaCRM — Sistema completo para lojas de celular" },
      {
        property: "og:description",
        content:
          "ERP + CRM + IA + App mobile em uma única plataforma. Controle total da sua loja de celular.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "ERP, CRM e IA para lojas de celular: estoque por IMEI, ordem de serviço, vendas, fiscal, financeiro e WhatsApp.",
        }),
      },
      {
        type: "application/ld+json",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          mainEntity: [
            {
              "@type": "Question",
              name: "Posso testar antes de pagar?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Sim. Você tem 3 dias grátis para testar todos os recursos do plano Pro Max, sem precisar de cartão.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Não. Você pode cancelar quando quiser. O pacote anual oferece desconto, mas é opcional.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Sim. Usamos criptografia em repouso e em trânsito, com backups diários e isolamento total entre lojas.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "O sistema é cloud-first, mas o app mobile mantém ações essenciais em cache para continuar vendendo se a internet cair.",
              },
            },
            {
              "@type": "Question",
              name: "Importam meus dados do sistema antigo?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Sim. Importamos seu estoque, clientes e histórico via planilha, sem custo, em qualquer plano.",
              },
            },
          ],
        }),
...
const features = [
  {
    icon: Box,
    title: "Estoque por IMEI/SN",
    desc: "Controle aparelhos, peças e acessórios com rastreio individual por IMEI ou número de série.",
  },
  {
    icon: Wrench,
    title: "Ordem de Serviço",
    desc: "OS completa com checklists, termos de garantia personalizados e acompanhamento técnico.",
  },
  {
    icon: CreditCard,
    title: "PDV e Vendas",
    desc: "Venda, upgrade, troca e assistência em segundos. Múltiplas formas de pagamento.",
  },
  {
    icon: FileText,
    title: "Módulo Fiscal",
    desc: "NF-e, NFC-e e NF de Upgrade emitidas direto do sistema, sem retrabalho.",
  },
  {
    icon: BarChart3,
    title: "+30 Relatórios e Dashboards",
    desc: "DRE, fluxo de caixa, vendas por vendedor, ranking de produtos, margem real e muito mais.",
  },
  {
    icon: Bot,
    title: "IA Blue — Pós-venda automático",
    desc: "IA que conversa, agradece, pede avaliação e reativa clientes inativos no WhatsApp.",
  },
  {
    icon: MessageCircle,
    title: "CRM Multicanal",
    desc: "WhatsApp, Instagram e Phone unificados. Funil Kanban com etapas e automações.",
  },
  {
    icon: Smartphone,
    title: "App Android e iOS",
    desc: "Sua loja no bolso: vendas, OS, estoque e mensagens com sincronização em tempo real.",
  },
  {
    icon: Globe,
    title: "Catálogo Online",
    desc: "Vitrine pública com link compartilhável, integrada ao seu estoque.",
  },
  {
    icon: Tag,
    title: "Etiquetas e Códigos",
    desc: "Imprima etiquetas para produtos, peças e ordens de serviço com 1 clique.",
  },
  {
    icon: Calendar,
    title: "Aniversários automáticos",
    desc: "Mensagem de aniversário enviada sozinha — clientes voltam mais.",
  },
  {
    icon: Zap,
    title: "Automação total",
    desc: "Gatilhos, fluxos e mensagens programadas. Configure uma vez, funciona para sempre.",
  },
];
...
const differentials = [
  {
    ...
    desc: "Crie sua conta, importe seu estoque e comece a vender hoje mesmo.",
  },
  {
    icon: ShieldCheck,
    title: "Dados isolados por loja",
    desc: "Multi-tenant com criptografia. Seus dados nunca se misturam com os de outra loja.",
  },
  {
    icon: TrendingUp,
    title: "Atualizações semanais",
    desc: "Novas funcionalidades toda semana, sem custo extra.",
  },
  {
    icon: Bell,
    title: "Suporte humano",
    desc: "Time de atendimento real, em português, todos os dias.",
  },
];
      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-background/70 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-muted-foreground">
            ...
            <a href="#diferenciais" className="hover:text-foreground transition">
              Diferenciais
            </a>
          ...
          <div className="text-left">
            <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-4 py-1.5 text-xs mb-7">
              ...
              <span className="text-muted-foreground">
                +3.000 lojas já transformaram a operação
              </span>
            </div>
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-xl">
              Controle total de estoque por IMEI, vendas, assistência técnica, CRM e pós-venda em
              uma única plataforma simples e poderosa.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <span className="text-xs font-semibold text-primary uppercase tracking-wider">
              Feito para lojas que querem crescer
            </span>
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              O ConectaCRM nasceu para resolver os principais desafios das lojas de celular e
              assistência técnica.
            </p>
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-5 relative">
              ...
              <div className="rounded-2xl border border-rose-200 bg-rose-50/50 dark:bg-rose-950/20 dark:border-rose-900/40 p-6">
                <h3 className="font-bold text-rose-600 dark:text-rose-400 mb-4">
                  Sem o ConectaCRM
                </h3>
                <ul className="space-y-4">
                  {[
                    [
                      ...
                      "Você não sabe o que tem, o que vendeu e o que falta.",
                    ],
                    [
                      "Perda de vendas e clientes",
                      "Orçamentos perdidos e atendimentos sem follow-up.",
                    ],
                    [
                      "Assistência técnica bagunçada",
                      "Ordens de serviço em papel, anotações e planilhas.",
                    ],
                    [
                      "Falta de informações para decidir",
                      "Sem relatórios, você trabalha no escuro.",
                    ],
                    [
                      "Processos manuais que tomam tempo",
                      "Mais trabalho, menos produtividade e mais erros.",
                    ],
                  ].map(([t, d]) => (
              ...
              <div className="rounded-2xl border border-emerald-200 bg-emerald-50/50 dark:bg-emerald-950/20 dark:border-emerald-900/40 p-6">
                <h3 className="font-bold text-emerald-600 dark:text-emerald-400 mb-4">
                  Com o ConectaCRM
                </h3>
                <ul className="space-y-4">
                  {[
                    ...
                    [
                      "Assistência técnica organizada",
                      "Ordens, status e histórico de cada aparelho.",
                    ],
                    [
                    ...
                    [
                      "Automação que faz o trabalho por você",
                      "Mais eficiência para focar no que realmente importa.",
                    ],
                  ].map(([t, d]) => (
                    <li key={t} className="flex gap-3">
          ...
          <div className="relative">
            ...
            <div className="absolute -right-2 sm:-right-4 top-6 bg-card border border-border rounded-2xl shadow-xl px-5 py-4 flex flex-col items-center text-center w-36">
              ...
              <p className="text-[11px] text-muted-foreground mt-1 leading-tight">
                lojas já confiam no ConectaCRM
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 rounded-3xl border border-border bg-card overflow-hidden grid md:grid-cols-[1fr_2fr_1fr]">
          ...
          <div className="p-8 md:p-12 text-center flex flex-col justify-center">
            <span className="text-xs font-semibold text-primary uppercase tracking-wider">
              O resultado que sua loja merece
            </span>
              ...
              {[
                {
                  ...
                  desc: "Automatize tarefas e foque em vender.",
                },
                {
                  icon: TrendingUp,
                  title: "Aumente suas vendas",
                  desc: "Atendimento rápido e informações na palma da mão.",
                },
                {
                  icon: Heart,
                  title: "Clientes satisfeitos",
                  desc: "Pós-venda eficiente e relacionamento que fideliza.",
                },
              ].map((b) => (
          ...
          <div className="hidden md:block">
            <img
              src={attendantLaptop}
              alt="Atendente trabalhando no ConectaCRM"
              width={1024}
              height={768}
              loading="lazy"
              className="w-full h-full object-cover"
      ...
      <section id="funcionalidades" className="max-w-7xl mx-auto px-4 sm:px-6 py-24">
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-5 text-muted-foreground text-base md:text-lg">
            Do atendimento à venda, do estoque ao pós-venda — tudo conectado e automatizado para
            você vender mais e se preocupar menos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {[
              ...
              mock: (
                <div className="rounded-xl bg-card border border-border shadow-sm p-3 text-[11px]">
                  ...
                  <div className="flex justify-between py-1.5 border-t border-border/60">
                    <span>Total</span>
                    <span className="text-primary font-bold">R$ 3.499,00</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-t border-border/60">
                    <span>Pagamento</span>
              ...
              mock: (
                <div className="rounded-xl bg-card border border-border shadow-sm p-3 text-[11px]">
                  ...
                  {[
                    ...
                    <div
                      key={id}
                      className="flex justify-between items-center py-1 border-t border-border/60"
                    >
              ...
              mock: (
                <div className="rounded-xl bg-card border border-border shadow-sm p-3 text-[11px] space-y-1.5">
                  <div className="flex items-center gap-2 pb-2 border-b border-border/60">
                    <div className="h-7 w-7 rounded-full bg-emerald-500/20 grid place-items-center text-emerald-600 font-bold">
                      C
                    </div>
                    <div>
                  ...
                  <div className="bg-muted/60 rounded-lg rounded-tl-none px-2.5 py-1.5 max-w-[80%]">
                    Olá! Ainda tem iPhone 14 128GB?
                  </div>
                  <div className="bg-emerald-500/15 text-emerald-900 dark:text-emerald-100 rounded-lg rounded-tr-none px-2.5 py-1.5 max-w-[80%] ml-auto">
                    Temos sim! Quer reservar?
                  </div>
                  <div className="bg-muted/60 rounded-lg rounded-tl-none px-2.5 py-1.5 max-w-[80%]">
                    Quero sim, pode separar 😊
                  </div>
                </div>
              ),
            },
                ...
                <div className="rounded-xl bg-card border border-border shadow-sm p-3 text-[11px] space-y-1.5">
                  ...
                  {[
                    ...
                    <div key={i} className="flex gap-2 py-1 border-t border-border/60">
                      <div className="h-7 w-7 rounded-lg bg-primary/15 grid place-items-center text-primary shrink-0">
            ...
            <div
              key={f.title}
              className="group relative rounded-3xl border border-border bg-card overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <div className="px-5 pb-5 -mt-1">{f.mock}</div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-8 rounded-3xl border border-border bg-gradient-to-br from-primary/5 via-card to-card overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-center">
              ...
              <div className="grid grid-cols-1 gap-4 mt-6">
                {[
                  ...
                  <div key={t} className="flex gap-3 items-start">
                    <div className="h-9 w-9 rounded-lg bg-primary/15 grid place-items-center text-primary shrink-0">
            ...
            <div className="lg:col-span-6 relative h-full min-h-[280px]">
              <img
                src={featDevices}
                alt="Sistema em laptop e celular"
                loading="lazy"
            ...
            <div className="lg:col-span-3 p-8 lg:p-10 lg:border-l border-border">
              ...
              <p className="text-sm md:text-[15px] leading-relaxed text-foreground/90">
                O ConectaCRM mudou totalmente a forma como gerencio minha loja. Hoje tenho tempo,
                controle e resultados de verdade!
              </p>
              <div className="flex items-center gap-3 mt-5">
                <img
                  src={testimonialLeandro}
                  alt="Leandro Silva"
                  loading="lazy"
                ...
                <div>
                  ...
                  <div className="text-[11px] text-muted-foreground">
                    Loja Conexão Cell · Cliente desde 2023
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={s.label} className="rounded-2xl bg-card border border-border p-6 text-center">
              ...
              <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary to-emerald-500 bg-clip-text text-transparent">
                {s.value}
              </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
          {[
            ...
            <div
              key={name}
              className="h-16 rounded-xl border border-border bg-card grid place-items-center text-sm font-semibold text-muted-foreground hover:text-foreground hover:border-primary/40 transition"
            >
              {name}
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {plans.map((p) => (
            ...
            >
              ...
              <p className={`text-sm ${p.highlight ? "opacity-90" : "text-muted-foreground"}`}>
                {p.pitch}
              </p>
              ...
              <div className="text-center mb-2">
                <div className="flex items-baseline justify-center gap-1">
                  <span
                    className={`text-base ${p.highlight ? "opacity-80" : "text-muted-foreground"}`}
                  >
                    12x
                  </span>
                ...
                <p
                  className={`text-sm mt-2 ${p.highlight ? "opacity-90" : "text-muted-foreground"}`}
                >
                  Mensal R$ {p.monthly}
                </p>
                <p
                  className={`text-xs mt-1 ${p.highlight ? "opacity-75" : "text-muted-foreground"}`}
                >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-24">
          ...
          <div className="rounded-2xl border border-border bg-card overflow-hidden">
            <div className="grid grid-cols-3 text-sm">
              ...
              <div className="p-4 font-semibold border-b border-border bg-primary/5 text-center">
                ConectaCRM
              </div>
              <div className="p-4 font-semibold border-b border-border text-center text-muted-foreground">
                Outros
              </div>
              {[
          ...
          {[
            {
              ...
              a: "Sim. Você tem 3 dias grátis para testar todos os recursos do plano Pro Max, sem precisar de cartão.",
            },
            {
              q: "Tem fidelidade?",
              a: "Não. Você pode cancelar quando quiser. O pacote anual oferece desconto, mas é opcional.",
            },
            {
              q: "Meus dados ficam seguros?",
              a: "Sim. Usamos criptografia em repouso e em trânsito, com backups diários e isolamento total entre lojas.",
            },
            {
              q: "Funciona offline?",
              a: "O sistema é cloud-first, mas o app mobile mantém ações essenciais em cache para continuar vendendo se a internet cair.",
            },
            {
              q: "Importam meus dados do sistema antigo?",
              a: "Sim. Importamos seu estoque, clientes e histórico via planilha, sem custo, em qualquer plano.",
            },
          ].map((item) => (
            <details key={item.q} className="group rounded-xl border border-border bg-card p-5">
              <summary className="cursor-pointer font-semibold flex items-center justify-between list-none">
                {item.q}
                <span className="ml-4 text-muted-foreground group-open:rotate-45 transition">
                  +
                </span>
              </summary>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
              <Link to="/registro">
                <Button
                  size="lg"
                  variant="secondary"
                  className="rounded-full text-base px-8 h-12 bg-white text-primary hover:bg-white/90"
                >
              ...
              <Link to="/login">
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-full text-base px-8 h-12 bg-transparent border-white/40 text-white hover:bg-white/10"
                >
                  Já tenho conta
                </Button>
              </Link>
