...
export const Route = createFileRoute("/automacao")({
  head: () => ({
    meta: [
      { title: "Automações — ConectaCRM" },
      { name: "description", content: "Fluxos automáticos de atendimento e CRM." },
    ],
  }),
...
function AutomationPage() {
  ...
  const seedTemplates = async () => {
    ...
    const presets = [
      {
        ...
        config: {
          message:
            "Olá {{nome}}! 👋 Recebemos seu contato e em instantes um vendedor falará com você.",
        },
      },
      {
        ...
        config: {
          message:
            "Olá! No momento estamos fora do nosso horário de atendimento (08h às 18h). Retornaremos pela manhã. 🙏",
      ...
      },
      {
        ...
        config: {
          ...
          email_body:
            "<p>Olá {{nome}},</p><p>Obrigado pela confiança! Já é nosso cliente. 🎉</p><p>Equipe ConectaCRM</p>",
    ...
    const toInsert = presets
      ...
      .map((p) => ({ ...p, user_id: user.id, is_active: true }));
    if (toInsert.length === 0) {
      toast.info("Os 4 fluxos prontos já existem.");
      return;
    }
          ...
          <div className="rounded-2xl bg-gradient-sidebar-cta p-8 text-white shadow-elegant relative overflow-hidden mb-8">
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="text-white/85 text-lg mb-6 leading-relaxed">
                Configure gatilhos que disparam mensagens, criam tarefas e movem leads no funil
                automaticamente.
              </p>
              <Button
                onClick={() => setOpen(true)}
                className="h-11 px-6 rounded-xl bg-white text-primary font-bold hover:bg-white/90 gap-2"
              >
              ...
              <Button
                ...
                variant="outline"
                className="ml-3 h-11 px-6 rounded-xl border-white/30 bg-white/10 text-white hover:bg-white/20 gap-2"
              >
          ...
          {loading ? (
            ...
            <div className="bg-card border border-border rounded-2xl p-12 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Crie seu primeiro fluxo para automatizar tarefas repetitivas.
              </p>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <span
                        className={`text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full ${a.is_active ? "bg-success/10 text-success border border-success/20" : "bg-muted text-muted-foreground border border-border"}`}
                      >
            ...
            {form.action_type === "send_message" && (
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Olá {{nome}}, obrigado pelo contato!"
                />
              </div>
            )}
              ...
              <>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Olá {{nome}}, estamos felizes em ter você conosco."
                  />
                </div>
              </>
            )}
