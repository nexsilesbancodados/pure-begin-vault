  ...
  return (
    <div className="p-4 md:p-6 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card
          className="cursor-pointer group hover:border-primary/50 transition-all border-border/40 bg-card/50 shadow-sm"
          onClick={() => navigate({ to: "/pdv" })}
        >
        ...
        <Card
          className="cursor-pointer group hover:border-primary/50 transition-all border-border/40 bg-card/50 shadow-sm"
          onClick={() => navigate({ to: "/vendas/orcamentos" })}
        >
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
        ...
        <div className="flex items-center justify-between px-1">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Últimas transações realizadas em tempo real.
            </p>
          </div>
          <Button
            variant="ghost"
