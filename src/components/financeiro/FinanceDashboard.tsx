              ...
              {transactions.slice(0, 5).map((t, i) => (
                ...
                >
                  <div className="flex items-center gap-3 flex-1 overflow-hidden">
                    <div
                      className={`h-8 w-8 rounded-lg flex items-center justify-center ${t.type === "income" ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"}`}
                    >
                      {t.type === "income" ? (
        ...
        <DialogContent className="sm:max-w-[500px] rounded-3xl">
          <DialogHeader>
            <DialogTitle className="text-xl font-black text-foreground flex items-center gap-2">
              ...
              {selectedCard === "saidas" && (
                <>
                  <TrendingDown className="h-5 w-5 text-red-600" /> Detalhes de Saídas
                </>
              )}
              {selectedCard === "saldo" && (
                <>
